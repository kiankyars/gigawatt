"""Build the evidence-bound Phase 1 generation teaching pilot.

Usage: uv run python diagram/generate_phase1_generation.py
"""
...
OUTPUT = ROOT / "diagram" / "phase1_generation.html"
...
def build() -> tuple[str, str, int]:
    ...
    payload = teaching_visuals.compile_generation_landscape(
        manifest,
        ledgers,
