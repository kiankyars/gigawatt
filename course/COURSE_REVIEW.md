...
| 7. [Continuity, storage and protection](prototypes/continuity-format.html?teach=1) | 34 scenes; supplied stored-energy image followed by the contact/arc sequence, differentiated shared-bus fault, Microsoft quote and two closing checks | [Current checks](TESTING.md#chapter-7-isolation-clarity-and-case-placement--2026-09-15) | **Active review; September 15 feedback addressed.** Sparks uses the dated reported 1 MW pilot; current nameplate remains unresolved. The 800 V feeder moved to Chapter 8. |
