...
| 6. [Campus and building power distribution](prototypes/distribution-format.html?teach=1) | 25 slides; two overview focus views, switchgear before physical conductors, Compass co-design lead-in, real taps photo and clearer PF comparison | [Sequence review checks](TESTING.md#chapter-6-overview-sequence-and-image-review--2026-09-15) | **Accepted chapter; September 15 revisions implemented.** Earlier acceptance remains recorded. Compass stays here for its distribution functions; manufacturing/interface detail is handed to Chapter 14. Existing scene hashes retained. |
