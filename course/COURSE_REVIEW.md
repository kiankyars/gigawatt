...
| 8. [Rack power and buffering](prototypes/rack-energy-format.html?teach=1) | 16 slides; rack hardware, conversion near the chip, VRMs, one connected storage diagram, load swings and recharge | [Split checks](TESTING.md#rack-power-and-dc-distribution-chapter-split--2026-09-16) | **Accepted and verified — 16 September 2026.** Kian explicitly approved the current 16-slide Chapter 8, including the merged storage/support diagram. Chapters 1–8 are verified. |
| 9. [800 V DC distribution](prototypes/dc-distribution-format.html?teach=1) | 15 slides; conductor comparison, conversion placement, 50 V/800 V rack-bus paths, transformer-first versus SST supply paths, retained three-column architecture comparison, Zurich-West, DC protection and retrofit | [Split checks](TESTING.md#rack-power-and-dc-distribution-chapter-split--2026-09-16) | **Revision implemented — 16 September 2026; author review continues.** Architecture views now motivate the supply equipment. The two rack-bus paths explicitly retain the 50 V versus 800 V distinction. The author’s preferred three-column AC/sidecar/direct-MV comparison remains; the overlapping two-column image is retired. No whole-chapter acceptance inferred. |
| 10. [Networking and interconnects](prototypes/networking-format.html?teach=1) | 24 slides; named scale-up/scale-out/WAN examples, Microsoft Superfactory image, supplied leaf–spine overview, full data hierarchy, real DGX H100/QM9700 fabric path, collective communication and failure diagnosis | [Current checks](TESTING.md#chapter-9-scope-and-chapter-13-delivery--2026-09-16) | **Authored; author review in progress.** September 16 networking review revisions implemented through the physical fabric example; user-supplied optics and Microsoft images installed; redundant data-hierarchy labels removed. No whole-chapter acceptance inferred. |
| 11. [Storage and recovery](prototypes/storage-format.html?teach=1) | 12 slides; Llama 3 recovery, Meta storage tiers, surviving checkpoints, repair and allocation, repeated-work energy, Google demand response and one recovery check | [Current checks](TESTING.md#chapter-11-storage-and-recovery-condensed--2026-09-16) | **Shortened for author review; not yet accepted.** Detailed storage and checkpoint mechanics remain in the three reader lessons. |
...
Following the compute migration and the AC/DC chapter split, Networking is Chapter 10 and [Storage and recovery is Chapter 11](prototypes/storage-format.html?teach=1). The storage deck now has 12 slides centered on infrastructure decisions: storage tiers, surviving saves, repair and placement, the energy cost of repeated computation, and flexible demand. Detailed checkpoint and orchestration mechanics remain in the reading. The closing exercise requires a surviving checkpoint, a feasible allocation, a validated environment and correct new output. Author review remains open.
