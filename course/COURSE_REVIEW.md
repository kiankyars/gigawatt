...
| 9. [800 V DC distribution](prototypes/dc-distribution-format.html?teach=1) | 16 slides; conductor comparison, conversion placement, 50 V/800 V rack-bus paths, transformer-first versus SST supply paths, supplied architecture comparison, Zurich-West, DC protection and retrofit | [Split checks](TESTING.md#rack-power-and-dc-distribution-chapter-split--2026-09-16) | **Revision implemented — 16 September 2026; author review continues.** Architecture views now motivate the supply equipment. The two rack-bus paths explicitly retain the 50 V versus 800 V distinction. A high-level AC/DC comparison replaces the isolated converter-loss exercise. No whole-chapter acceptance inferred. |
| 10. [Networking and interconnects](prototypes/networking-format.html?teach=1) | 24 slides; named scale-up/scale-out/WAN examples, Microsoft Superfactory image, full data hierarchy, real DGX H100/QM9700 fabric path, collective communication and failure diagnosis | [Current checks](TESTING.md#chapter-9-scope-and-chapter-13-delivery--2026-09-16) | **Authored; author review in progress.** September 16 networking review revisions implemented through the physical fabric example; user-supplied optics and Microsoft images installed; redundant data-hierarchy labels removed. No whole-chapter acceptance inferred. |
