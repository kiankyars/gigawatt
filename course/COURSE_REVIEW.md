...
| 8. [Rack power and buffering](prototypes/rack-energy-format.html?teach=1) | 19 slides; rack hardware, documented Clemente 51 V → 12 V conversion, VRM switching, local storage, load swings and the power-stack recap | [Split checks](TESTING.md#rack-power-and-dc-distribution-chapter-split--2026-09-16) | **Accepted and verified — 16 September 2026.** Kian approved Chapter 8 including the merged storage/support diagram, then requested the existing power-stack image as its final recap after recharge. The accepted 17-slide sequence remains verified; the two authorized Clemente/VRM additions await author review. |
