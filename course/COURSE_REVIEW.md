...
| 5. [Physical site, buildings and safety](prototypes/site-format.html?teach=1) | 22 scenes; Docklands and Harvey context pairs; interactive exit routes; concise replacement check | [Current checks](TESTING.md#chapter-5-context-and-ending-revision--2026-09-13) | **Latest feedback addressed; acceptance pending.** Liked engineering cases preserved; context added before each. Final fire and replacement slides revised. |
