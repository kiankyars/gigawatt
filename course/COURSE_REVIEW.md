...
| 9. [800 V DC distribution](prototypes/dc-distribution-format.html?teach=1) | 15 slides; conductor comparison, conversion placement, 50 V/800 V rack-bus paths, transformer-first versus SST supply paths, Zurich-West and the power-stack map; closes with DC protection, retrofit and the three-column architecture recap | [Split checks](TESTING.md#rack-power-and-dc-distribution-chapter-split--2026-09-16) | **Accepted after requested edit — 16 September 2026.** Kian approved Chapter 9 upon replacing slide 10 with the supplied transformer-first/SST image. The image is installed unchanged; the 50 V versus 800 V rack-bus distinction remains. The preferred three-column comparison is now the final recap, after protection and the retrofit example; all 15 slides are retained. |
