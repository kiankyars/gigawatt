...
| 6. [Campus and building power distribution](prototypes/distribution-format.html?teach=1) | 27 slides; simplified equipment views, beer analogy, PF comparison and supplied reactive-power quote | [Final review checks](TESTING.md#chapters-6-and-7-final-author-review--2026-09-15) | **Accepted and verified — 15 September.** Final requested wording and image changes implemented. Existing scene hashes retained. |
...
| 8. [Rack power and the 800 V DC transition](prototypes/rack-energy-format.html?teach=1) | 34 scenes; explicit PSU/VRM/Vcore path, direct-versus-staged conversion, contextual VRM phases, named BBU and support map | [September 15 review checks](TESTING.md#chapter-8-converters-and-buffering--2026-09-15) | **Active author review through the former slide 17.** [Every current point and resolution](CHAPTER_8_REVIEW.md) recorded individually; remaining slides not yet accepted. |
| 9. [Compute, memory and the rack](prototypes/compute-format.html?teach=1) | 22 slides: supplied hardware meme after opening; GB300 anatomy, memory locality and bandwidth, operand reuse, roofline, switched rack, repair and job placement | [Current checks](TESTING.md#chapter-9-compute-memory-and-the-rack--2026-09-14) | **Authored and checked; ready for first author review.** Three reader lessons updated. No author acceptance inferred. |
...
| 11. [Storage, orchestration and recovery](prototypes/storage-format.html?teach=1) | 26 slides; supplied component-price meme after opening; input bottlenecks, coherent checkpoints, recovery, Meta/Google cases and deadline scheduling | [Current checks](TESTING.md#chapter-11-storage-orchestration-and-recovery--2026-09-14) | **Authored and checked; ready for first author review.** Three D09 reader lessons updated. |
