...
| 6. [Campus and building power distribution](prototypes/distribution-format.html?teach=1) | 26 slides; simplified one-line and Compass views, beer analogy before the power-factor comparison | [Final review checks](TESTING.md#chapters-6-and-7-final-author-review--2026-09-15) | **Accepted and verified — 15 September.** Final requested wording and image changes implemented. Existing scene hashes retained. |
