...
| 16. [Putting an AI Factory Together](prototypes/integrated-cases-format.html?teach=1) | 10 slides; Abilene connects hardware requirements, cooling choice, real manufacturing, capital and live expansion; a photographic sequence closes the course | [Current verification](TESTING.md) | **Revised after author review — 18 September 2026; acceptance pending.** Cooling alternatives added, hot-weather repetition removed, real construction/factory images installed, financing clarified, and closing rebuilt. ChatGPT image prompt supplied. Original exercises remain optional reader practice. |
