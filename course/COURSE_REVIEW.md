...
| 6. [Campus and building power distribution](prototypes/distribution-format.html?teach=1) | 30 slides; three-phase conductors, distribution equipment and power factor; new power triangle follows the beer analogy | [Latest checks](TESTING.md#chapter-8-sequence-and-dc-architecture-review--2026-09-15) | **Accepted and verified — 15 September.** Final requested wording and image changes implemented. Existing scene hashes retained. The subsequently authorized power-triangle addition awaits review. |
...
| 16. [Putting an AI Factory Together](prototypes/integrated-cases-format.html?teach=1) | 11 slides; Abilene connects hardware, cooling, manufacturing, investment and expansion; two photographic recap slides lead to the supplied conceptual closing illustration | [Current verification](TESTING.md) | **Revised after author review — 18 September 2026; acceptance pending.** Cooling alternatives added, hot-weather repetition removed, real construction/factory images installed, financing clarified, and closing rebuilt. Supplied ChatGPT illustration installed after both retained photographic slides. Original exercises remain optional reader practice. |
...
- [x] Power triangle audit followed by explicit author authorization: one concise slide now follows the Chapter 6 beer analogy (slide 24).
...
- [x] Chapter 6: requested power-triangle slide added after the beer analogy.
