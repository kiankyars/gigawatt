...
| 9. [800 V DC distribution](prototypes/dc-distribution-format.html?teach=1) | 16 slides; conductor comparison, conversion placement, 50 V/800 V rack-bus paths, supply equipment, architecture changes, Zurich-West, DC protection and retrofit | [Split checks](TESTING.md#rack-power-and-dc-distribution-chapter-split--2026-09-16) | **Revision implemented — 16 September 2026; author review continues.** Architecture views now motivate the supply equipment. The two rack-bus paths explicitly retain the 50 V versus 800 V distinction. A high-level AC/DC comparison replaces the isolated converter-loss exercise. No whole-chapter acceptance inferred. |
