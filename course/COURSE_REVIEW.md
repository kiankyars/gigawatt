...
| 11. [Chip and rack heat capture](prototypes/cooling-format.html?teach=1) | 17 slides; four separate capture methods, CRAH/CDU comparison, chip temperature, simultaneous pump curves, simpler approach and redundancy examples | [Revision checks](TESTING.md#chapter-11-clarity-and-controls--2026-09-16) | **Author review in progress.** Requested cuts and simplifications implemented; not yet accepted. |
| 12. [Heat rejection, climate and water](prototypes/heat-rejection-format.html?teach=1) | 17 slides; recurring heat path, early Abilene example, humidity, progressive temperature gaps, interactive hot-hour power budget, water paths and customer availability | [Revision checks](TESTING.md#chapter-12-intuition-and-operating-decisions--2026-09-16) | **Revised; ready for author review.** |
| 13. [Design, procurement and commissioning](prototypes/procurement-cases-format.html?teach=1) | 24 slides; early fixed-20 MW rack change, simultaneous branch comparisons, preserved EPC/freeze/ownership slides and supplied cases, physical failure response and rack-level service decision | [Current checks](TESTING.md#chapter-13-intuitive-delivery-and-preserved-additions--2026-09-16) | **Revised following author audit approval.** Previously requested standalone topics and supplied examples retained. Final author review remains pending. |
| 14. [Controls, operations and reliability](prototypes/operations-format.html?teach=1) | 18 slides; local evidence, proven cooling readiness and service recovery; simultaneous comparisons, adjacent Cloudflare failure/follow-up and two simple scenario controls | [Revision checks](TESTING.md#chapter-14-simpler-explanations-and-comparisons--2026-09-16) | **Revised; ready for author review.** Covers all five D14 objectives and closes with one load-release question and reveal. No author acceptance inferred. |
