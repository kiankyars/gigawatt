...
facts, not extra approval steps. Kian accepted Chapters 1–4 on 14 September after the requested revisions. Revisit only changed slides or a specific unresolved issue; a new
...
| 6. [Campus and building power distribution](prototypes/distribution-format.html?teach=1) | 20 slides; 345 kV / 34.5 kV campus reference, explicit CT and HV CVT view, contextual protection and busway figures | [Current checks](TESTING.md#chapter-6-abilene-voltages-and-instrument-transformers--2026-09-14) | **Active review; latest feedback addressed.** Abilene voltage references, slide 5 CT/CVT teaching and slide 6 “Air gap” implemented. [Scope and remaining verification](FEEDBACK_AUDIT.md#chapter-6-voltages-and-instrument-transformers--14-september-2026). Fresh browser interaction check of the new slide 5 view remains pending because the built-in browser tool is unavailable. |
