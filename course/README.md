...
The optional D00 prelude is [Electricity basics and recurring terminology](prototypes/terminology-format.html),
with teaching mode at `prototypes/terminology-format.html?teach=1`.
...
(diagrams) directly. Its 16 slides have a provisional 20-minute target, pending rehearsal. D00 provides first exposure before the 15
curriculum domains; each term is taught again at its first useful application.

The following D01 sequence is `prototypes/orientation-format.html`, with spatial
...
Its thirteen scenes remain intact. D02 follows in `prototypes/workload-format.html`,
...
D00 and D02 are ready for an aloud dry run.
...
It is not the expanded course's curriculum authority or the D00 primer.
...
longer treatments live in D03, D05, D09, D11 and D12 reader lessons.
