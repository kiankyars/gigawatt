...
9. **The data center is the machine.** Use the campus, data-hall and GB200 reference photographs to bring the course together. The customer commitment funds construction; hardware defines the interfaces; local water conditions shape cooling; manufacturing and bridge power affect delivery; and expansion preserves the working service. The NVIDIA rack image is a manufacturer reference, not a claimed photograph of an Abilene-installed rack.
10. **Inside Abilene’s AI factory.** Preserve the full-frame Oracle data-hall photograph after the campus-to-rack recap. These remain two separate photographic slides before the new closing image.
11. **From Watts to Tokens.** Close with the user-supplied conceptual campus-to-chip illustration, installed unchanged apart from TIFF-to-PNG conversion. It is not an actual Abilene photograph. Suggested final line: “A token depends on much more than a chip. You can now follow its physical requirements back through the rack, the cooling plant, the electrical supply, and the decisions that made the campus possible.” The campus's MW rating alone cannot establish a token rate. The [ChatGPT prompt](CHAPTER_16_CLOSING_IMAGE_PROMPT.md) records the illustration's brief.
