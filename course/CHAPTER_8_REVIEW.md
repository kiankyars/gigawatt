...
- **Chapter 9, slide 15 — power-stack map:** improve contrast of dark secondary text. Its separate semiconductor layer can also imply a serial conversion stage; explain visually that these devices operate inside PSUs and VRMs. The 18.3–30 kW per-PSU range and 25–40% lower-loss figure need named product/comparison context before being presented as general specifications. Removing the ASP label did not verify the remaining market figures.
