import {scenes,initialState} from './storage-scenes.js';
import {storageVisual} from './storage-visuals.js';
...
function render(){
 ...
 document.title=`${presentationLabels.storage||'11. Storage and recovery'} · ${s.label}`;
