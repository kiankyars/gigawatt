...
export const initialState={transfer:'cluster',uplinks:2,placement:'remote',message:'large',ringRound:0,collectiveRate:50,ocsPairing:'straight',diagnosis:'',showDiagnosis:false};
export const scenes=[
 ...
 {id:'packet-path',label:'From the GPU to another rack',title:'The network adapter carries data from a compute tray into the fabric.',reference:topology,pedagogical_role:'mechanism',controls:[c('transfer','Follow the data',[['rack','Inside the rack'],['cluster','Across racks']])]},
