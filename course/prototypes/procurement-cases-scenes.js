...
export const scenes=[
 ...
 s('rack-change','Same power, fewer racks','The same 2 MW zone uses half as many racks.',interfaces,'D13.2','Ten 2 MW zones change from twenty 100 kW racks per zone to ten 200 kW racks. The following three slides track what this change does to each electrical branch, coolant branch and support position.',{pedagogical_role:'comparison'}),
