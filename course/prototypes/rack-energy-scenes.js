...
const supplement = [
  ...
  {id:'rack-inlet-ledger',label:'Account for every inlet watt',title:'Processor power leaves out parallel loads and conversion heat.',reference:ledger,kind:'ledger',pedagogical_role:'balance',
  ...
  {id:'retrofit-power',label:'The sidecar needs upstream power',title:'Moving the converter leaves its power demand on the feeder.',reference:migration,kind:'retrofit',pedagogical_role:'counterexample',
