...
const reviewFigures = [
  ...
  {id:'power-stack-overview',label:'The power stack, from grid to chip',title:'The power stack, from grid to chip',reference:ledger,kind:'review-figure',pedagogical_role:'recap',
    ...
    explanation:['The supplied industry map closes Chapter 8 by joining the grid, building, rack and chip perspectives. Follow the functions from the top to the GPU die after the rack conversion and buffering examples.','Power semiconductors are technologies inside power converters, not necessarily a separate serial conversion stage. The chart’s companies, highlights and market metrics remain the source’s dated industry overview, not measured plant performance or a bill of materials for this course.'],
...
const dcSteps = Object.fromEntries([...electrical,dcPreview,supplement[2],greenCase,dcProtection,supplement[3]].map(scene=>[scene.id,scene]));
export const scenes = Object.freeze([...local,reviewFigures[1]]);
export const dcScenes = Object.freeze([
  ...
  'green-zurich-west','dc-feeder-protection','retrofit-power','ocp-power-architectures'
].map(id=>dcSteps[id]));
