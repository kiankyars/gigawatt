...
const electrical = samplePresentation.steps.filter(step=>!['dc-circuit','ac-cycle','three-phase','voltage-basis'].includes(step.id)).flatMap(step=>{
  ...
  return [{...scene,label:'Step down first or rectify first?',title:'Should we step down first or rectify first?',kind:'dc-supply-options',source_ids:['P21','P22','P45'],
...
const dcChanges = {id:'dc-architecture-changes',label:'AC hall versus DC hall',title:'What changes when the hall distributes DC?',reference:'d06-eight-hundred-volt-architectures',kind:'review-figure',imageTitle:true,asset:'dc-hall-before-after.png',alt:'Two parallel paths compare conventional AC distribution in the hall with upstream rectification and 800 V DC busway. Rectification moves upstream, hall distribution changes, and local device conversion remains.',pedagogical_role:'comparison',source_ids:['P05'],
