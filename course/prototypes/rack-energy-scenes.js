...
const clementePower = {id:'clemente-power-board',label:'Meta’s GB300 power board',title:'Meta’s GB300 tray steps 51 V down to 12 V before local regulation.',reference:ledger,kind:'clemente-power',pedagogical_role:'example',
  explanation:['Meta’s Clemente compute tray is a published GB300 implementation. Its NVIDIA-designed power distribution board converts the rack bus to 12 V before supplying the compute modules. The diagram separates that tray-level conversion from local regulation at the processors.',
    ...
    'The final processor voltages and regulator phase count are not specified here. The document excludes the GB300 module’s internal design. The local-regulation box completes the functional path without assigning an exact core voltage or claiming every GB300 implementation uses this intermediate rail.'],
