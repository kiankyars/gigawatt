...
export function renderEnergyPassThrough(){
  return `<div class="ke-pass-through">
    <div class="ke-contracts">
      <section><h2>Fixed all-in price</h2><p class="ke-risk-owner">Provider absorbs<br>the increase</p></section>
      <section><h2>Electricity pass-through</h2><p class="ke-risk-owner">Customer pays<br>the increase</p></section>
    </div>
  </div>`;
}
