...
export const scenes = Object.freeze([
  ...
  s('rejection', 'Air or evaporation', 'Air carries heat away. Evaporation helps cool water.', rejection, 'D11.1',
    'A dry cooler passes outdoor air over a closed coil. The liquid must be warmer than the entering air to give up heat. A wet tower lets some water evaporate, cooling the water left behind. Most tower water recirculates; replacement water supplies the losses.'),
  s('weather', 'Why humidity matters', 'Humid air leaves less room for evaporative cooling.', weather, 'D11.3',
    ...
    {controls: [c('humidity', 'Same air temperature', [['dry', 'Dry air'], ['humid', 'Humid air']])]}),
  s('approach-outdoors', 'Follow the temperatures', 'Each heat exchanger needs a temperature gap.', weather, 'D11.3',
    ...
    {controls: [c('humidity', 'Outdoor air', [['dry', 'Dry air'], ['humid', 'Humid air']])]}),
  s('chiller-balance', 'What a chiller adds', 'A chiller moves heat and adds its own.', rejection, 'D11.2',
    'When the direct cooling path cannot meet the required supply temperature, refrigeration can lift heat from a colder circuit to a warmer outdoor sink. Keep this separate simple chiller example: 10 MW collected plus 2 MW compressor electricity gives 12 MW condenser heat at steady state. Pumps and fans lie outside this illustration’s boundary. Air- and water-cooled chillers describe where the condenser sends heat.'),
