...
function fromHash(){const id=location.hash.slice(1);const found=scenes.findIndex(scene=>scene.id===id);index=found<0?0:found;render();$('stage').scrollTop=0;window.scrollTo(0,0);}
