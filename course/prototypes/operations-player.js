import {scenes,initialState,sceneAliases} from './operations-scenes.js';
...
function render(){
 ...
 $('decision-reveal')?.addEventListener('click',()=>{state.showDecision=!state.showDecision;focusAfter('#decision-reveal');});
}
