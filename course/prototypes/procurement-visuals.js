...
export function procurementVisual(id,state){
 ...
 case 'factory-and-site':return `<div class="p-stack"><div class="p-scope-columns"><section><h2>Factory assembly</h2><div class="p-frame"><span>Electrical distribution</span><span>Coolant manifolds</span><span>Wiring + controls</span></div></section><span class="p-concurrent" aria-label="In parallel">∥</span><section><h2>Site construction</h2><div class="p-site-scope"><span>Foundations + access</span><span>Utility connections</span><span>Outdoor cooling plant</span></div></section></div><div class="p-factory-join"><span>Delivery + placement</span>${arrow}<span>Field connections</span>${arrow}<span>Integrated testing</span></div></div>`;
 ...
 case 'rack-change':return `<div class="p-stack"><div class="p-two p-rack-comparison"><section><h2>Before: one 2 MW zone</h2>${racks(20)}${result('20 × 100 kW','200 racks across the data center')}</section><section><h2>After: one 2 MW zone</h2>${racks(10,true)}${result('10 × 200 kW','100 racks across the data center')}</section></div></div>`;
