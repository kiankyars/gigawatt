...
Lenovo’s GB300 NVL72 guide, updated August 30, 2026, gives a 600 mm-wide MGX rack and a compute tray weighing 29 kg. That tray is 799 mm deep including its rear water connections. These dimensions identify the physical object that must be accessed and handled; they are not service clearances or the installed rack’s total mass.
...
## Separate Tier topology, availability and the investment decision

Uptime Institute tiers describe outcomes of the site infrastructure, including power and cooling. Tier I establishes basic capacity. Tier II adds redundant capacity components. Tier III requires concurrent maintainability: planned equipment or path maintenance can occur with IT operating. Tier IV adds tolerance of a single infrastructure fault and continuous cooling. A count such as N+1 or 2N alone does not determine the tier. The full design, its separation and its response to events matter.

Tier I already includes an engine generator for utility outages. Higher tiers inherit that baseline. For Tier III and IV, the generator plant must support critical load without runtime limits in its applicable capacity rating, but it need not run continuously. Fuel supply, refueling and operating permissions remain real constraints. This backup-generation requirement differs from choosing a continuously operated behind-the-meter gas plant.

Availability targets answer a different question. In a 365-day example that counts every minute at one service boundary, 99.9% allows 525.6 minutes of downtime (8 h 45 min 36 s), 99.99% allows 52.56 minutes (52 min 33.6 s), and 99.999% allows 5.256 minutes (5 min 15.36 s). A 45-minute outage consumes 85.6% of the four-nines annual allowance and already exceeds the five-nines allowance. Uptime removed expected-downtime assignments in 2009. An actual SLA may use another window, request-based accounting or exclusions; it cannot be inferred from a tier label.

The investment decision follows the service requirement. Uptime's 14 December 2015 case describes a U.S. cloud facility certified at Tier III with other Tier IV capabilities already in place. The owner planned to add the mechanical UPS needed for continuous cooling once a client required Tier IV and justified the expense. The case describes a commercial use, not a government-only category; it does not establish completion of the later phase or the share of the market at any tier.
...
- [Tier Certification for Modular and Phased Construction](https://journal.uptimeinstitute.com/modular-and-phased-construction/) — Commercial U.S. cloud case: Tier III constructed-facility phase with other Tier IV capabilities already in place; mechanical UPS investment for continuous cooling deferred until a client required the planned Tier IV phase. Read 2026-09-12. Substantive publisher-indexed Tier III-to-Tier IV case text reviewed; direct page requests returned 403. Historical 2015 case, not a current facility status report. Does not establish that the later phase completed, that cooling alone upgrades every Tier III site, or market prevalence of a Tier.
