...
- [The powered cluster that keeps waiting](lessons/c04-stalled-job.md) — Which physical segment limits communication, and would upgrading it shorten the complete job cycle?
...
### 17. ERCOT and PJM: the race to connect

- Slides: [ERCOT and PJM: the race to connect](prototypes/grid-queues-format.html?teach=1)
- [ERCOT and PJM: the race to connect](lessons/d03-interconnection-queues.md) — When does a request for a gigawatt become usable power?
...
| Explain the milestones and constraints between a proposed large load and service available to that load. | [Deliver the campus one usable phase at a time](lessons/d03-service-and-siting.md), [Open one phase, with evidence](lessons/c05-open-a-phase.md), [ERCOT and PJM: the race to connect](lessons/d03-interconnection-queues.md) |
| Compare utility-only and behind-the-meter supply against energy, capacity, fuel and operating requirements; distinguish customer-side location from island capability. | [A contract is not a cable](lessons/d03-power-and-procurement.md), [Deliver the campus one usable phase at a time](lessons/d03-service-and-siting.md), [ERCOT and PJM: the race to connect](lessons/d03-interconnection-queues.md) |
...
Crusoe identifies the original eight-building Oracle/OpenAI campus as a 1,200 MW plan. Oracle reports 75% of total Abilene capacity delivered as of September 2026. Applying that percentage to the 1,200 MW plan gives 900 MW only if both sources use the same capacity basis. Oracle does not define that basis or provide current operating MW, so 900 MW is a conditional calculation rather than a reported energized or IT-load figure. The 10 GW commitment belongs to Stargate’s wider US buildout; it is not the Abilene campus denominator.
...
FPL’s Dania Beach Clean Energy Center is a combined-cycle utility power station near Fort Lauderdale. Its two GE 7HA.03 gas turbines work with a steam cycle that recovers exhaust heat; GE reports up to 1,260 MW for the whole plant. In the model designation, 7 identifies the 60 Hz family, H means high efficiency, A means air-cooled and .03 identifies the model version. The name does not encode the turbine’s megawatt output. The plant figure includes the steam cycle.
...
Colossus 2 is on Tulane Road in Memphis, Tennessee; MZX’s generation site is on Stanton Road in Southaven, Mississippi. SemiAnalysis’s September 2025 account attributes the cross-border siting to Tennessee pushback and Mississippi’s temporary-turbine permitting route, and reports medium-voltage connections between the sites. Nearby parcels can have different permitting authorities while power delivery still requires a physical connection.
...
The July 2025 Mississippi determination included mobility and less-than-twelve-month conditions. The temporary treatment was not indefinite permission. On July 30, 2026, SpaceXAI reported an agreed timeline to remove 69 temporary turbines by July 2027 while constructing permitted permanent generation. This describes a historical permission and a later transition commitment, not completed removal. TVA’s Southaven combined-cycle station is a separate plant.
...
- [Oracle Data Centers: Abilene, Texas](https://www.oracle.com/data-centers/) — Abilene section explicitly reports 75% of total capacity delivered as of September 2026. Includes genuine aerial photographs captioned July 15, 2026. Read 2026-09-13. Oracle does not define its delivered-capacity basis. 75% × the separately reported 1,200 MW campus plan gives 900 MW only if those bases match; it is not a reported operating MW value. Photographs are dated July 15, 2026.
...
- [Applied Digital — October 2025 investor presentation](https://ir.applieddigital.com/sec-filings/all-sec-filings/content/0001144879-25-000076/apld_invxfinalpresentati.htm) — Original slide 22 provides two aerial photographs of Polaris Forge 1 Building 1. Read 2026-09-13. October presentation date; exact photograph capture days unknown. Photos must not be labeled as Oct 27 or Nov 24 captures.
- [GE — How its latest gas turbine could save Florida customers money](https://www.ge.com/news/reports/in-the-money-how-ges-latest-gas-turbine-could-help-save-florida-customers-300-million) — GE naming explanation: H means high efficiency, A means air-cooled. Dania Beach uses a combined-cycle design. Read 2026-09-13. Model designation is not an output rating; article forecasts and savings claims are not used.
- [GE Vernova — Supporting Vietnam’s energy needs](https://www.gevernova.com/gas-power/resources/articles/2021/supporting-vietnams-energy-needs) — Distinguishes 7HA for 60 Hz grids from 9HA for 50 Hz grids. Read 2026-09-13. Family identification only; no Vietnam project performance transferred to Dania Beach.
- [SpaceXAI — Greater Memphis site update, July 30, 2026](https://x.ai/memphis/updates) — Reports agreement to remove 69 temporary Southaven turbines by July 2027 while building permitted permanent generation. Read 2026-09-13. Operator statement and future removal deadline, not verification of completed removal or environmental performance.
- [MDEQ — Determination letter on portable gas combustion turbines, July 29, 2025](https://cdn.mississippitoday.org/wp-content/uploads/2025/11/20104011/2025.07.29-MDEQ-Determination-Letter-on-Portable-Gas-Combustion-Turbines-signed.pdf) — Historical determination includes mobility and less-than-twelve-month conditions for the temporary-turbine treatment. Read 2026-09-13. Indexed primary text reviewed; full PDF fetch returned HTTP 403. Does not establish indefinite or current permission.
...
Colossus 1 at Paul Lowery Road in Memphis, Tennessee occupies the former Electrolux factory. This is our brownfield redevelopment example; Abilene’s original phase supplies the greenfield comparison. Reuse can retain a shell, roads and utility access, while a new site offers more freedom to arrange structures and routes. Neither label decides cost or opening date. SpaceXAI uses the name Colossus 1 in its May 2026 Anthropic announcement; the accompanying official site aerial shows the converted industrial shell, with no capture date supplied.
...
- [Railroad Commission of Texas — Oil and Gas Exploration and Surface Ownership](https://www.rrc.texas.gov/about-us/faqs/oil-gas-faq/oil-gas-exploration-and-surface-ownership/) — Texas surface and mineral estates can be separately owned; mineral development can entail reasonably necessary surface use subject to applicable limits. Read 2026-09-12. Texas-specific general guidance. It neither determines the title of a particular parcel nor prescribes the rights needed for a data-center transaction.
...
- [Applied Digital Achieves Ready for Service for Phase 1 at Polaris Forge 1](https://ir.applieddigital.com/news-events/press-releases/detail/133/applied-digital-achieves-ready-for-service-for-phase-1-at) — First 50 MW of the first 100 MW building at Polaris Forge 1 in Ellendale, North Dakota reached ready-for-service on October 27, 2025. Use as an actual phased handover example. Read 2026-09-12. Operator announcement of ready-for-service capacity, not measured draw or all hardware installed. The campus was 400 MW fully contracted to CoreWeave, with an indicated future expansion path to 1 GW; it was not an operating multi-gigawatt campus.
- [Applied Digital Completes Phase II Ready for Service at Polaris Forge 1](https://ir.applieddigital.com/news-events/press-releases/detail/137/applied-digital-completes-phase-ii-ready-for-service-at) — Second 50 MW of the first building reached ready-for-service November 24, 2025, bringing that building to 100 MW. Compare the two documented milestones. Read 2026-09-12. The 28 days between milestones can illustrate earlier availability of capacity, but no resulting compute, utilization or energy delivery is measured by this release.
- [SpaceXAI — New Compute Partnership with Anthropic](https://x.ai/news/anthropic-compute-partnership) — The operator explicitly names Colossus 1; use that name for the Paul Lowery Road industrial-reuse case. Read 2026-09-12. May 2026 operator announcement. The naming reference is not a site commissioning record or independent verification of every capacity claim.
- [SpaceXAI — Colossus site aerial](https://x.ai/colossus) — Official aerial photograph of the Colossus 1 industrial shell and surrounding infrastructure. Read 2026-09-12. Capture date is unspecified. Image inspected; do not infer operating capacity, equipment state or present construction progress from a photograph.
- [TDEC — Colossus water-reuse public hearing, SOP-24025](https://www.tn.gov/environment/calendar-of-events/2025/6/25/wr-public-hearing-sop-24025.html) — Names the xAI Colossus data center as a proposed reclaimed-water customer for evaporative cooling. Read 2026-09-12. June 2025 hearing record establishes the stated cooling use; it does not establish that the proposed reuse plant is operating. Shared project water quantities are not Colossus-only consumption.
...
- [Intel — Fully Integrated Voltage Regulator (FIVR)](https://edc.intel.com/content/www/us/en/design/ipla/software-development-platforms/servers/platforms/intel-pentium-silver-and-intel-celeron-processors-datasheet-volume-1-of-2/fully-integrated-voltage-regulator-fivr/) — Compute-die FIVRs derive processor rails from an upstream platform VCCIN regulator. Integration relocates final regulation while retaining upstream conversion. Read 2026-09-18. Documented Intel implementation; not evidence that GB300 uses an IVR or that all processor rails are integrated.
...
An 800 V supply at the rack inlet does not require one specific voltage on the vertical rack bus. One design converts 800 V to roughly 50 V at the rack entrance, then distributes that lower voltage vertically to the trays. Another carries 800 V along the vertical bus and steps it down near the trays. Both still need local conversion and regulation to supply processor rails; 800 V does not feed a processor directly.
...
- [Inside the 800VDC Revolution – Part 1](https://newsletter.semianalysis.com/p/inside-the-800vdc-revolution-part) — May 2026 forecast distinguishing rack-shelf and on-blade step-down, plus the supplied SST market forecast and its equipment-content assumption. Read 2026-09-10. Analyst forecast, not observed revenue, commissioned capacity, an independently reproduced market model or a requirement to use SSTs. Unlabelled 2026/2027 revenue bars and exact GW values are not inferred from chart pixels.
