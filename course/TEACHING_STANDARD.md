...
| Campus and building distribution (`d04`) | Compass skid separates switching from transformation; Fujitsu busway preserves branch flexibility; Green Zurich-West moves rectification upstream | Primary-source case photos and technical accounts in the reader | Integrated in [Chapter 6](prototypes/distribution-format.html?teach=1): `compass-skid`, `fujitsu-busway`, `green-dc`; active extension check-in at `expansion-decision` |
