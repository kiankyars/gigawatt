...
| --- | --- |
| Watts | [NIST SI table](https://www.nist.gov/pml/special-publication-811/nist-guide-si-chapter-4-two-classes-si-units-and-si-prefixes) gives W = J/s. The slide describes an amount of energy transferred per second, avoiding an implication about propagation speed. |
...
| Voltage variation and transformer limits | [Rohde & Schwarz, Testing AC/DC Converters, pp. 26–30](https://scdn.rohde-schwarz.com/ur/pws/dl_downloads/dl_application/application_notes/1sl387/1SL387_2e_TestingACDC_Converters.pdf) illustrates DC-output ripple and load-change excursions. [Schneider transformer taps](https://www.se.com/us/en/faqs/FA120846/) explains how changing voltage into a fixed transformer connection affects its output, and how taps accommodate supply differences. The two 12 V diagrams and ±10% controls are original teaching levels, not operating tolerances or transformer ratings. DC is flat in the first AC/DC comparison; its changing level is taught separately. |
| Constant three-phase total power | [Introduction to Electrical Power Engineering, Power and Energy](https://pb.ee.pw.edu.pl/pb/iepe/chapter/power-and-energy/) derives total instantaneous power as the sum of the three voltage-current products. The new original 30 kW example uses a balanced sinusoidal source and equal resistors: each phase is 20 sin²(theta + offset) kW and the three sum to 30 kW. It does not select the largest waveform or depict a constant supply voltage. |
