...
class ChangeOwnershipCoverageTests(unittest.TestCase):
    ...
    def test_actual_current_canonical_change_scope_is_declared(self) -> None:
        ...
        self.assertLessEqual(
            {
                ...
                "course/README.md",
                "course/REDLINE.md",
                "course/quality_ratchet.yaml",
                "src/gigawatt/champion.py",
                "src/gigawatt/quality.py",
        ...
        archived_evidence_paths = {
            path
            for path in canonical_changed_paths
            if path.startswith("course/acceptance_evidence/")
        }
        declared_archived_evidence_paths = {
            path
            for path in declared_source_paths
            if path.startswith("course/acceptance_evidence/")
        }
        self.assertEqual(len(archived_evidence_paths), 23)
        self.assertEqual(
            archived_evidence_paths,
            declared_archived_evidence_paths,
        )
